...
1.  Calculate LCOE by Monte Carlo Simulation.
    * Draw LCOE Cost Paramaters from various statistical distributions.
    * Distributional choice is determined by historical data on costs across energy sources.
    * Collate point source data from EIA and LAZARD LCOE reports. Use the data to establish boundary conditions for the choosen distributions.
